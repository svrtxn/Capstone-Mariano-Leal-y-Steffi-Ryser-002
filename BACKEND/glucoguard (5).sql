...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-12-2025 a las 06:25:48
...
--
-- Estructura de tabla para la tabla `usuarios_push_tokens`
--

CREATE TABLE `usuarios_push_tokens` (
...
--
-- Indices de la tabla `usuarios_push_tokens`
--
ALTER TABLE `usuarios_push_tokens`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_usuario_push_token` (`usuario_id`);
...
--
ALTER TABLE `alertas`
  MODIFY `alerta_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID de alerta', AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT de la tabla `configuraciones`
--
ALTER TABLE `configuraciones`
  MODIFY `config_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `contactosapoyo`
--
ALTER TABLE `contactosapoyo`
  MODIFY `contacto_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT de la tabla `nivelesglucosa`
--
ALTER TABLE `nivelesglucosa`
  MODIFY `glucosa_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Identificador único de la medición de glucosa', AUTO_INCREMENT=120;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `usuario_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del usuario', AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT de la tabla `usuarios_push_tokens`
--
ALTER TABLE `usuarios_push_tokens`
...
--
-- Filtros para la tabla `usuarios_push_tokens`
--
ALTER TABLE `usuarios_push_tokens`
  ADD CONSTRAINT `fk_usuario_push_token` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON DELETE CASCADE;
COMMIT;
